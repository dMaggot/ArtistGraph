...
being too low (https://dev.mysql.com/doc/refman/5.1/en/server-system-variables.html#sysvar_max_allowed_packet).
...
have auto increment keys and indices, which were incremented after each insert. 
(https://www.mediawiki.org/wiki/Manual:MWDumper#Performance_Tips)
