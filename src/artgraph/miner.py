...
class Miner(object):
    ...
    def mine_internal(self, current_node, level=0, parent=None, relationship=None):
        ...
        self.task_queue.append(self.master.submit_task(infoboxplugin.get_nodes, input_data=(infoboxplugin,), modules=("artgraph.plugins.infobox", "MySQLdb", "mwparserfromhell")))
